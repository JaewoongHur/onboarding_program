...
#ifndef MY_INTERFACES__SRV__DETAIL__SEND_TEXT__FUNCTIONS_H_
#define MY_INTERFACES__SRV__DETAIL__SEND_TEXT__FUNCTIONS_H_
...
/// Initialize srv/SendText message.
/**
 ...
 * )) before or use
 * my_interfaces__srv__SendText_Request__create()
...
/// Create srv/SendText message.
/**
 * It allocates the memory for the message, sets the memory to zero, and
 * calls
 * my_interfaces__srv__SendText_Request__init().
...
/// Destroy srv/SendText message.
/**
 * It calls
 * my_interfaces__srv__SendText_Request__fini()
...
/// Check for srv/SendText message equality.
/**
...
/// Initialize array of srv/SendText messages.
/**
...
/// Finalize array of srv/SendText messages.
/**
 * It calls
 * my_interfaces__srv__SendText_Request__fini()
...
/// Create array of srv/SendText messages.
/**
 * It allocates the memory for the array and calls
 * my_interfaces__srv__SendText_Request__Sequence__init().
 * \param[in] size The size / capacity of the array.
...
/// Destroy array of srv/SendText messages.
/**
 * It calls
 * my_interfaces__srv__SendText_Request__Sequence__fini()
 * on the array,
...
/// Check for srv/SendText message array equality.
/**
...
/// Copy an array of srv/SendText messages.
/**
 * This functions performs a deep copy, as opposed to the shallow copy that
 * plain assignment yields.
 *
 ...
 * )) before or use
 * my_interfaces__srv__SendText_Response__create()
 * to allocate and initialize the message.
 * \return true if initialization was successful, otherwise false
 */
ROSIDL_GENERATOR_C_PUBLIC_my_interfaces
 ...
 * It allocates the memory for the message, sets the memory to zero, and
 * calls
 * my_interfaces__srv__SendText_Response__init().
 * \return The pointer to the initialized message if successful,
 * otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_my_interfaces
...
/**
 * It calls
 * my_interfaces__srv__SendText_Response__fini()
 * and frees the memory of the message.
 * \param[in,out] msg The allocated message pointer.
 */
ROSIDL_GENERATOR_C_PUBLIC_my_interfaces
...
/**
 * It allocates the memory for the array and calls
 * my_interfaces__srv__SendText_Response__Sequence__init().
 * \param[in] size The size / capacity of the array.
 * \return The pointer to the initialized array if successful, otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_my_interfaces
...
/**
 * It calls
 * my_interfaces__srv__SendText_Response__Sequence__fini()
 * on the array,
 * and frees the memory of the array.
 * \param[in,out] array The initialized array pointer.
 */
 ...
 * )) before or use
 * my_interfaces__srv__SendText_Event__create()
 * to allocate and initialize the message.
 * \return true if initialization was successful, otherwise false
 */
ROSIDL_GENERATOR_C_PUBLIC_my_interfaces
 ...
 * It allocates the memory for the message, sets the memory to zero, and
 * calls
 * my_interfaces__srv__SendText_Event__init().
 * \return The pointer to the initialized message if successful,
 * otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_my_interfaces
...
/**
 * It calls
 * my_interfaces__srv__SendText_Event__fini()
 * and frees the memory of the message.
 * \param[in,out] msg The allocated message pointer.
 */
ROSIDL_GENERATOR_C_PUBLIC_my_interfaces
...
/**
 * It allocates the memory for the array and calls
 * my_interfaces__srv__SendText_Event__Sequence__init().
 * \param[in] size The size / capacity of the array.
 * \return The pointer to the initialized array if successful, otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_my_interfaces
...
/**
 * It calls
 * my_interfaces__srv__SendText_Event__Sequence__fini()
 * on the array,
 * and frees the memory of the array.
 * \param[in,out] array The initialized array pointer.
 */
...
#endif  // MY_INTERFACES__SRV__DETAIL__SEND_TEXT__FUNCTIONS_H_
